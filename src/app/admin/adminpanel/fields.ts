export const fields = {
    ...
    milestone: [
        { name: 'id', label: 'ID', type: 'text', errorMessage: 'ID is required',required: true },
        { name: 'roadmapId', label: 'Roadmap ID', type: 'text', errorMessage: 'Roadmap ID is required', required: true },
    ...
    question: [
        { name: 'testQuizId', label: 'Test Quiz', type: 'number', errorMessage: 'Test Quiz is required', required: true },
