...
export const DEVOPS_MILESTONES: Milestone[] = [
  ...
  export const AI_MILESTONES = [
    { id: 1, title: 'Introduction to AI', description: 'Begin your journey in artificial intelligence.', courseLink: '', certificationSuggestion: '' },
    // ... more ai milestones ...
  ];
  
  export const DATA_SCIENCE_MILESTONES = [
    { id: 1, title: 'Data Science Fundamentals', description: 'Explore the basics of data science.', courseLink: '', certificationSuggestion: '' },
